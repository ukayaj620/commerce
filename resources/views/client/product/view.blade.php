...
<div class="d-flex flex-lg-row flex-column justify-content-start align-items-center container w-100 p-0 my-4">
  <div class="col-lg-4 col d-flex align-items-center justify-content-center p-0">
    <img class="shadow rounded img-fluid" src="{{ asset('storage/' . $product->product_image->image_path) }}">
  </div>
  <div class="col-lg-8 col px-4 px-lg-0 d-flex flex-column mt-4">
    <div class="d-flex flex-column">
      <p class="ml-3 font-weight-bold">Deskripsi Produk</p>
      <p class="col-8">
        {{ $product->description }}
      </p>
    </div>
